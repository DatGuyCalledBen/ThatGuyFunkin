export function createScene(engine, canvas) {
    ...
    const BPM = 175
    const QuantisationFactor = 1/32000
    ...
    const pointLight1 = new BABYLON.PointLight("pointLight1", new BABYLON.Vector3(3, 3, 0), scene);
    ...
    const pointLight2 = new BABYLON.PointLight("pointLight2", new BABYLON.Vector3(-3, 3, 0), scene);
