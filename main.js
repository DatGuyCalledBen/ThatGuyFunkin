    ...
    function updateSpriteBasedOnTime() {
        try {
            ...
            for (let entry of danceData1) {
                if (entry.t >= t0 + l1 && currentTime <= entry.t && entry.d != d1 && entry.l <= (1000*beatDuration*2)) {
                    t0 = currentTime
                    l1 = entry.l
                    d1 = entry.d
            ...
            for (let entry of danceData2) {
                if (entry.t >= t0 + l2 && currentTime <= entry.t && entry.d != d1 && entry.l <= (1000*beatDuration*2)) {
                    t0 = currentTime
                    l2 = entry.l
                    d2 = entry.d
